...
def _oper_names():
    ...
    if not names:
        _OPER_ERROR = ('공정명을 얻지 못했습니다. equipment/tech_map.py 의 '
                       'OPER_NAME_MAP 에 {OPER_ID: 공정명} 을 등록하세요. '
