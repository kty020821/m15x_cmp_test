...
urlpatterns = [
    ...
    path('api/monitor/start/',   vm.monitor_start,      name='monitor-start'),
    path('api/monitor/jobstat/', vm.monitor_job_status, name='monitor-jobstat'),
    path('api/monitor/jobstop/', vm.monitor_job_cancel, name='monitor-jobstop'),
